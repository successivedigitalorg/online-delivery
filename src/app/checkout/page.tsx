      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
        <div className="lg:col-span-2">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <h2 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4">Delivery Details</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                ...
                <div>
                  <label htmlFor="phone" className="block mb-1 text-sm sm:text-base">Phone Number *</label>
                  <input
                    type="tel"
                    id="phone"
                    name="phone"
                ...
                <div>
                  <label htmlFor="address" className="block mb-1 text-sm sm:text-base">Delivery Address *</label>
                  <input
                    type="text"
                    id="address"
                    name="address"
            ...
            <div>
              <label htmlFor="specialInstructions" className="block mb-1 text-sm sm:text-base">Special Instructions</label>
              <textarea
                id="specialInstructions"
                name="specialInstructions"
                value={formData.specialInstructions}
                onChange={handleInputChange}
                className="w-full border border-gray-300 rounded-md px-3 py-2 h-20 sm:h-24 text-sm sm:text-base"
            ...
            <div>
              ...
              <div className="flex flex-col space-y-3">
                ...
                <label className="flex items-center gap-2 cursor-pointer opacity-50 text-sm sm:text-base">
                  <input
                    type="radio"
                    name="paymentMethod"
        ...
        <div className="bg-gray-50 p-4 sm:p-6 rounded-lg h-fit sticky top-20">
          ...
          <div className="space-y-2 mb-4 max-h-60 overflow-y-auto text-sm sm:text-base">
            {items.map((item) => (
          ...
          <div className="border-t pt-4 mt-4">
            ...
            <div className="border-t my-4 pt-4 flex justify-between font-bold text-sm sm:text-base">
              <span>Total</span>
